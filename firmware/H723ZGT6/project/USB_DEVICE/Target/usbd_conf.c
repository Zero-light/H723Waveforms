...
USBD_StatusTypeDef USBD_LL_Init(USBD_HandleTypeDef *pdev)
{
  ...
  /* Conservative FIFO sizing for FS mode (total <= 1024 words / 4096 bytes) */
  HAL_PCDEx_SetRxFiFo(&hpcd_USB_OTG_HS, 0x80);    /* RxFIFO: 128 words = 512 bytes */
  HAL_PCDEx_SetTxFiFo(&hpcd_USB_OTG_HS, 0, 0x20); /* EP0 Tx: 32 words = 128 bytes */
  HAL_PCDEx_SetTxFiFo(&hpcd_USB_OTG_HS, 1, 0x40); /* EP1 Tx (CDC Data IN): 64 words = 256 bytes */
  HAL_PCDEx_SetTxFiFo(&hpcd_USB_OTG_HS, 2, 0x20); /* EP2 Tx (CDC CMD IN): 32 words = 128 bytes */
